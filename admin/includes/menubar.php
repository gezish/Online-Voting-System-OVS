  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/admas2.jpg'; ?>" class="img-circle" alt="User Image">
      </div>
      <div class="pull-left info">
        <p><?php echo $user['firstname']. ''.$user['middlename']; ?></p>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>DASHBORD</span></a></li>
      <li class=""><a href="votes.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes</span></a></li>
      <li class="header">MANAGE</li>
      <li class=""><a href="adminaccount.php"><i class="fa fa-users"></i> <span>administrator</span></a></li>
